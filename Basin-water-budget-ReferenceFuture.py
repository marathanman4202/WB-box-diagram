...
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_secs/cst.Willamette_Basin_area_at_PDX*100.
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_secs/cst.Willamette_Basin_area_at_PDX*100.
...
data_v1 = mfx(file_model_csv_w_path, column=Col_num, skip=cst.day_of_year_oct1) # Read csv file into matrix
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_days/10.
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_days/10.
...
data_v1 = mfx(file_model_csv_w_path, column=Col_num, skip=cst.day_of_year_oct1) # Read csv file into matrix
Value_Ref_Max_Summer = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMaximum')/10.
Value_Ref_Min_Summer = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMinimum')/10.
Value_Ref_Max_Winter = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMaximum')/10.
Value_Ref_Min_Winter = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMinimum')/10.
...
Value_Ref_Summer_max = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMax') 
Value_Ref_Summer_min = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMin') 
Value_Ref_Summer_delta = Value_Ref_Summer_max - Value_Ref_Summer_min
Value_Ref_Winter_max = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMax')
Value_Ref_Winter_min = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMin')
...
data_v1 = np.sum([mfx(file_model_csv_w_path, column=j, skip=cst.day_of_year_oct1) for j in Col_num],0)/10. # Read csv file cols into matrices and sum the matrices
Value_HC_Summer_max = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMax') 
Value_HC_Summer_min = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMin') 
Value_HC_Summer_delta = Value_HC_Summer_max - Value_HC_Summer_min
Value_HC_Winter_max = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMax')
Value_HC_Winter_min = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMin')
...
data_v1 = np.sum([mfx(file_model_csv_w_path, column=j, skip=cst.day_of_year_oct1) for j in Col_num],0)/10. # Read csv file cols into matrices and sum the matrices
Value_LC_Summer_max = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMax') 
Value_LC_Summer_min = nrc(data_v1,[59, summer_start],[89,summer_end],oper='AverageMin') 
Value_LC_Summer_delta = Value_Ref_Summer_max - Value_Ref_Summer_min
Value_LC_Winter_max = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMax')
Value_LC_Winter_min = nrc(data_v1,[59, winter_start],[89,winter_end],oper='AverageMin')
Value_LC_Winter_delta = Value_Ref_Winter_max - Value_Ref_Winter_min

Value_for = np.mean(np.array([Value_Ref]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Summer_max = np.mean(np.array([Value_Ref_Summer_max]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Summer_min = np.mean(np.array([Value_Ref_Summer_min]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Summer_delta = np.mean(np.array([Value_Ref_Summer_delta]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Winter_max = np.mean(np.array([Value_Ref_Winter_max]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Winter_min = np.mean(np.array([Value_Ref_Winter_min]))*0.727  #Fraction of soil to be treated like forest for calc
Value_for_Winter_delta = np.mean(np.array([Value_Ref_Winter_delta]))*0.727  #Fraction of soil to be treated like forest for calc
...
Value_ag = np.mean(np.array([Value_Ref]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Summer_max = np.mean(np.array([Value_Ref_Summer_max]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Summer_min = np.mean(np.array([Value_Ref_Summer_min]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Summer_delta = np.mean(np.array([Value_Ref_Summer_delta]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Winter_max = np.mean(np.array([Value_Ref_Winter_max]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Winter_min = np.mean(np.array([Value_Ref_Winter_min]))*0.273  #Fraction of soil to be treated like forest for calc
Value_ag_Winter_delta = np.mean(np.array([Value_Ref_Winter_delta]))*0.273  #Fraction of soil to be treated like forest for calc
...
file_model_csv_w_path = cst.path_data + file_model_csv       # Add path to data & stats files
data_v = np.array(np.genfromtxt(file_model_csv_w_path, delimiter=',',skip_header=1)) # Read csv file
Value_Ref = np.mean((np.array(data_v[:,Col_num]))[365:(cst.days_in_30_yrs-1)])*365/10.
data_v1 = mfx(file_model_csv_w_path, column=Col_num, skip=cst.day_of_year_oct1) # Read csv file into matrix
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_days/10.
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_days/10.
...
Col_num = 1
file_model_csv = "ET_by_LandCover_(mm)_Ref_Run0.csv"
file_model_csv_w_path = cst.path_data + file_model_csv       # Add path to data & stats files
data_v = np.array(np.genfromtxt(file_model_csv_w_path, delimiter=',',skip_header=1)) # Read csv file
Value_Ref = np.mean((np.array(data_v[:,Col_num]))[365:(cst.days_in_30_yrs-1)])*365/10.
data_v1 = mfx(file_model_csv_w_path, column=Col_num, skip=cst.day_of_year_oct1) # Read csv file into matrix
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_days/10.*0.727
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_days/10.*0.727

#Value = np.mean(np.array([Value_Ref]))*0.727  #Frac forest area
Value = nrc(data_v1,[59, 1],[89,365])*365./10.*.727
...
Value_Ref = np.mean((np.array(data_v[:,Col_num]))[365:(cst.days_in_30_yrs-1)])*365/10.
data_v1 = mfx(file_model_csv_w_path, column=Col_num, skip=cst.day_of_year_oct1) # Read csv file into matrix
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_days/10.*0.273
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_days/10.*0.273

#Value = np.mean(np.array([Value_Ref]))*0.273  #Frac ag area
Value = nrc(data_v1,[59, 1],[89,365])*365./10.*0.273
...
Col_num1 = 3
Col_num2 = 4
file_list = [cst.path_data + 'Blue_River_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Cottage_Grove_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Cougar_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Detroit_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Dorena_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Fall_Creek_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Fern_Ridge_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Foster_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Green_Peter_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Hills_Creek_Reservoir_(USACE)_Reservoir_Ref_Run0.csv',
             cst.path_data + 'Lookout_Point_Reservoir_(USACE)_Reservoir_Ref_Run0.csv']
...
Value_Ref_Summer_in = nrc(data_v_in,[59, summer_start],[89,summer_end])*summer_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Winter_in = nrc(data_v_in,[59, winter_start],[89,winter_end])*winter_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Summer_out = nrc(data_v_out,[59, summer_start],[89,summer_end])*summer_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Winter_out = nrc(data_v_out,[59, winter_start],[89,winter_end])*winter_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Summer_delta = nrc(data_v_delta, [59, summer_start],[89,summer_end])*summer_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Winter_delta = nrc(data_v_delta, [59, winter_start],[89,winter_end])*winter_days*86400./cst.Willamette_Basin_area*100.
Value_Ref_Summer_min =   nrc(data_v_cumsum,[59, summer_start],[89,summer_end],oper='AverageMin')/cst.Willamette_Basin_area*100.
Value_Ref_Summer_max =   nrc(data_v_cumsum,[59, summer_start],[89,summer_end],oper='AverageMax')/cst.Willamette_Basin_area*100.
Value_Ref_Winter_min =   nrc(data_v_cumsum,[59, winter_start],[89,winter_end],oper='AverageMin')/cst.Willamette_Basin_area*100.
Value_Ref_Winter_max =   nrc(data_v_cumsum,[59, winter_start],[89,winter_end],oper='AverageMax')/cst.Willamette_Basin_area*100.
...
file_model_csv_w_path = cst.path_data + file_model_csv       # Add path to data & stats files
data_v = np.array(np.genfromtxt(file_model_csv_w_path, delimiter=',',skip_header=1)) # Read csv file
Value_Ref = (np.mean((np.array(data_v[:,Col_num[0]]))[:(cst.days_in_30_yrs-1)]) +\
             np.mean((np.array(data_v[:,Col_num[1]]))[:(cst.days_in_30_yrs-1)]))*cst.seconds_in_yr/cst.Willamette_Basin_area*100.
...
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*summer_secs/cst.Willamette_Basin_area*100.
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*winter_secs/cst.Willamette_Basin_area*100.
...
file_model_csv_w_path = cst.path_data + file_model_csv       # Add path to data & stats files
data_v = np.array(np.genfromtxt(file_model_csv_w_path, delimiter=',',skip_header=1)) # Read csv file
Value_Ref = np.mean(np.sum(np.column_stack((np.array(data_v[59:90,1]),np.array(data_v[59:90,9]))),1))*100*365*cst.cfs_to_m3/cst.Willamette_Basin_area*100.
Value_Ref = Value_Ref*Basin_Pop/Metro_Pop

Col_num = range(1,9)
file_model_csv = "Daily_Urban_Water_Demand_Summary_Ref_Run0.csv"
file_model_csv_w_path = cst.path_data + file_model_csv       # Add path to data & stats files
data_v1 = np.sum([mfx(file_model_csv_w_path, column=j, skip=cst.day_of_year_oct1) for j in Col_num],0)  # Read csv file cols into matrices and sum the matrices
Value_Ref_Summer = nrc(data_v1,[59, summer_start],[89,summer_end])*100*summer_days*cst.cfs_to_m3/cst.Willamette_Basin_area*100.*1.11386
Value_Ref_Winter = nrc(data_v1,[59, winter_start],[89,winter_end])*100*winter_days*cst.cfs_to_m3/cst.Willamette_Basin_area*100.*1.11386

Value = np.mean(np.array([Value_Ref]))
Value = nrc(data_v1,[59, 1],[89,365])*100*365.*cst.cfs_to_m3/cst.Willamette_Basin_area*100.*1.11386
